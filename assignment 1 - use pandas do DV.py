...
This data set, with a lot of data, is very comprehensive and very representative. i downloaded it from “Kaggle.com”. My target is use Machine Learning knowledge to observe changes in the annual average temperature of major cities
And those day, I'm using PyCharm to practice Python, so i decide to us PyCharm to finish it.
'''
# In[1]:
